...
export { COOKING_NUTRITION_PRIMARY_PRECISE_TOPIC_QUERY } from './precise-topic.query';
export { COOKING_NUTRITION_PRIMARY_NATURAL_EXPRESSION_QUERY } from './natural-expression.query';
export { COOKING_NUTRITION_PRIMARY_IMPRECISE_INPUT_QUERY } from './imprecise-input.query';
export { COOKING_NUTRITION_PRIMARY_CROSS_TOPIC_QUERY } from './cross-topic.query';
export { COOKING_NUTRITION_PRIMARY_PRECISE_TOPIC_EXPECTED } from './precise-topic.expected';
export { COOKING_NUTRITION_PRIMARY_NATURAL_EXPRESSION_EXPECTED } from './natural-expression.expected';
export { COOKING_NUTRITION_PRIMARY_IMPRECISE_INPUT_EXPECTED } from './imprecise-input.expected';
export { COOKING_NUTRITION_PRIMARY_CROSS_TOPIC_EXPECTED } from './cross-topic.expected';
