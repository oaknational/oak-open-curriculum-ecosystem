...
export { SCIENCE_PRIMARY_PRECISE_TOPIC_2_QUERY } from './precise-topic-2.query';
export { SCIENCE_PRIMARY_PRECISE_TOPIC_3_QUERY } from './precise-topic-3.query';
export { SCIENCE_PRIMARY_NATURAL_EXPRESSION_QUERY } from './natural-expression.query';
export { SCIENCE_PRIMARY_NATURAL_EXPRESSION_2_QUERY } from './natural-expression-2.query';
export { SCIENCE_PRIMARY_NATURAL_EXPRESSION_3_QUERY } from './natural-expression-3.query';
export { SCIENCE_PRIMARY_IMPRECISE_INPUT_QUERY } from './imprecise-input.query';
export { SCIENCE_PRIMARY_IMPRECISE_INPUT_2_QUERY } from './imprecise-input-2.query';
export { SCIENCE_PRIMARY_IMPRECISE_INPUT_3_QUERY } from './imprecise-input-3.query';
export { SCIENCE_PRIMARY_CROSS_TOPIC_QUERY } from './cross-topic.query';
export { SCIENCE_PRIMARY_CROSS_TOPIC_2_QUERY } from './cross-topic-2.query';
export { SCIENCE_PRIMARY_CROSS_TOPIC_3_QUERY } from './cross-topic-3.query';
export { SCIENCE_PRIMARY_CROSS_TOPIC_4_QUERY } from './cross-topic-4.query';

// Re-export expected relevance
export { SCIENCE_PRIMARY_PRECISE_TOPIC_EXPECTED } from './precise-topic.expected';
export { SCIENCE_PRIMARY_PRECISE_TOPIC_2_EXPECTED } from './precise-topic-2.expected';
export { SCIENCE_PRIMARY_PRECISE_TOPIC_3_EXPECTED } from './precise-topic-3.expected';
export { SCIENCE_PRIMARY_NATURAL_EXPRESSION_EXPECTED } from './natural-expression.expected';
export { SCIENCE_PRIMARY_NATURAL_EXPRESSION_2_EXPECTED } from './natural-expression-2.expected';
export { SCIENCE_PRIMARY_NATURAL_EXPRESSION_3_EXPECTED } from './natural-expression-3.expected';
export { SCIENCE_PRIMARY_IMPRECISE_INPUT_EXPECTED } from './imprecise-input.expected';
export { SCIENCE_PRIMARY_IMPRECISE_INPUT_2_EXPECTED } from './imprecise-input-2.expected';
export { SCIENCE_PRIMARY_IMPRECISE_INPUT_3_EXPECTED } from './imprecise-input-3.expected';
export { SCIENCE_PRIMARY_CROSS_TOPIC_EXPECTED } from './cross-topic.expected';
export { SCIENCE_PRIMARY_CROSS_TOPIC_2_EXPECTED } from './cross-topic-2.expected';
export { SCIENCE_PRIMARY_CROSS_TOPIC_3_EXPECTED } from './cross-topic-3.expected';
export { SCIENCE_PRIMARY_CROSS_TOPIC_4_EXPECTED } from './cross-topic-4.expected';
