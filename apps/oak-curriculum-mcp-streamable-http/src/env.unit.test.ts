...
// PostHog product-analytics selection tests live in
// env-product-analytics.unit.test.ts; the live-Sentry invariant (MCP-361)
// lives in env-live-sentry.unit.test.ts.
