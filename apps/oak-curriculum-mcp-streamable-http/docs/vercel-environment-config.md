...
| `CANONICAL_HOST`                       | Unset — the app self-describes from each request's Host                                           | Set to the address the app is served at when an edge overrides the Host (MCP-172). Every OAuth metadata/resource/challenge URL then names `https://<value>`                                                                                                                           |
