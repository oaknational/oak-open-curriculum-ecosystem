 ...
 * 3. Run: pnpm -C apps/oak-open-curriculum-semantic-search es:setup reset
 * 4. Run: pnpm -C apps/oak-open-curriculum-semantic-search es:ingest-live
 * 5. Run: pnpm -C apps/oak-open-curriculum-semantic-search vitest run four-retriever-ablation
 *
