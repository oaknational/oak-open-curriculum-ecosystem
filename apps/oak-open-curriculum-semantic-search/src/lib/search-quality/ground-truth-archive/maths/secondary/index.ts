/**
 * Secondary ground truth queries - 12 queries, 3 per category.
 *
...
import { MATHS_SECONDARY_PRECISE_TOPIC_2_QUERY } from './precise-topic-2.query';
import { MATHS_SECONDARY_PRECISE_TOPIC_3_QUERY } from './precise-topic-3.query';
import { MATHS_SECONDARY_NATURAL_EXPRESSION_QUERY } from './natural-expression.query';
import { MATHS_SECONDARY_NATURAL_EXPRESSION_2_QUERY } from './natural-expression-2.query';
import { MATHS_SECONDARY_NATURAL_EXPRESSION_3_QUERY } from './natural-expression-3.query';
import { MATHS_SECONDARY_IMPRECISE_INPUT_QUERY } from './imprecise-input.query';
import { MATHS_SECONDARY_IMPRECISE_INPUT_2_QUERY } from './imprecise-input-2.query';
import { MATHS_SECONDARY_IMPRECISE_INPUT_3_QUERY } from './imprecise-input-3.query';
import { MATHS_SECONDARY_CROSS_TOPIC_QUERY } from './cross-topic.query';
import { MATHS_SECONDARY_CROSS_TOPIC_2_QUERY } from './cross-topic-2.query';
import { MATHS_SECONDARY_CROSS_TOPIC_3_QUERY } from './cross-topic-3.query';

// Import expected relevance
import { MATHS_SECONDARY_PRECISE_TOPIC_EXPECTED } from './precise-topic.expected';
import { MATHS_SECONDARY_PRECISE_TOPIC_2_EXPECTED } from './precise-topic-2.expected';
import { MATHS_SECONDARY_PRECISE_TOPIC_3_EXPECTED } from './precise-topic-3.expected';
import { MATHS_SECONDARY_NATURAL_EXPRESSION_EXPECTED } from './natural-expression.expected';
import { MATHS_SECONDARY_NATURAL_EXPRESSION_2_EXPECTED } from './natural-expression-2.expected';
import { MATHS_SECONDARY_NATURAL_EXPRESSION_3_EXPECTED } from './natural-expression-3.expected';
import { MATHS_SECONDARY_IMPRECISE_INPUT_EXPECTED } from './imprecise-input.expected';
import { MATHS_SECONDARY_IMPRECISE_INPUT_2_EXPECTED } from './imprecise-input-2.expected';
import { MATHS_SECONDARY_IMPRECISE_INPUT_3_EXPECTED } from './imprecise-input-3.expected';
import { MATHS_SECONDARY_CROSS_TOPIC_EXPECTED } from './cross-topic.expected';
import { MATHS_SECONDARY_CROSS_TOPIC_2_EXPECTED } from './cross-topic-2.expected';
import { MATHS_SECONDARY_CROSS_TOPIC_3_EXPECTED } from './cross-topic-3.expected';
...
export const MATHS_SECONDARY_ALL_QUERIES: readonly GroundTruthQuery[] = [
  ...
  combineGroundTruth(
    MATHS_SECONDARY_PRECISE_TOPIC_2_QUERY,
    MATHS_SECONDARY_PRECISE_TOPIC_2_EXPECTED,
  ),
  combineGroundTruth(
    MATHS_SECONDARY_PRECISE_TOPIC_3_QUERY,
    MATHS_SECONDARY_PRECISE_TOPIC_3_EXPECTED,
  ),
  ...
  combineGroundTruth(
    MATHS_SECONDARY_NATURAL_EXPRESSION_2_QUERY,
    MATHS_SECONDARY_NATURAL_EXPRESSION_2_EXPECTED,
  ),
  combineGroundTruth(
    MATHS_SECONDARY_NATURAL_EXPRESSION_3_QUERY,
    MATHS_SECONDARY_NATURAL_EXPRESSION_3_EXPECTED,
  ),
  ...
  combineGroundTruth(
    MATHS_SECONDARY_IMPRECISE_INPUT_2_QUERY,
    MATHS_SECONDARY_IMPRECISE_INPUT_2_EXPECTED,
  ),
  combineGroundTruth(
    MATHS_SECONDARY_IMPRECISE_INPUT_3_QUERY,
    MATHS_SECONDARY_IMPRECISE_INPUT_3_EXPECTED,
  ),
  // Cross topic queries
