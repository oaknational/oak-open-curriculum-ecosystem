...
export { ART_SECONDARY_PRECISE_TOPIC_QUERY } from './precise-topic.query';
export { ART_SECONDARY_NATURAL_EXPRESSION_QUERY } from './natural-expression.query';
export { ART_SECONDARY_IMPRECISE_INPUT_QUERY } from './imprecise-input.query';
export { ART_SECONDARY_CROSS_TOPIC_QUERY } from './cross-topic.query';
export { ART_SECONDARY_PRECISE_TOPIC_EXPECTED } from './precise-topic.expected';
export { ART_SECONDARY_NATURAL_EXPRESSION_EXPECTED } from './natural-expression.expected';
export { ART_SECONDARY_IMPRECISE_INPUT_EXPECTED } from './imprecise-input.expected';
export { ART_SECONDARY_CROSS_TOPIC_EXPECTED } from './cross-topic.expected';
