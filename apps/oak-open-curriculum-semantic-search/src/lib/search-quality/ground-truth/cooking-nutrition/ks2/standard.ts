/**
 * KS2 Cooking & Nutrition standard ground truth queries.
 *
...
/**
 * KS2 Cooking & Nutrition standard queries.
 */
export const COOKING_KS2_STANDARD_QUERIES: readonly GroundTruthQuery[] = [
  {
