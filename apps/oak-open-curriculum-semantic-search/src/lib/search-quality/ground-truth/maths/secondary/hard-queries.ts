/**
 * Hard ground truth queries for Secondary Maths lesson search.
 *
...
/**
 * Hard ground truth queries for Secondary Maths.
 *
 * These queries challenge the search system and prove the value of the
 * four-retriever hybrid architecture.
 */
