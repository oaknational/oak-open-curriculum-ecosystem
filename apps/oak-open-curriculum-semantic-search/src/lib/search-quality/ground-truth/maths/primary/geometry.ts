...
export const GEOMETRY_PRIMARY_QUERIES: readonly GroundTruthQuery[] = [
  {
    ...
    priority: 'high',
    description: 'Tests retrieval of Year 1 2D shapes content using curriculum terminology',
  },
  {
    query: '3D shapes Year 1',
    expectedRelevance: {
      'explore-recognise-and-compare-three-different-3d-shapes': 3,
      'explore-recognise-and-compare-three-more-3d-shapes': 3,
      'recognise-describe-and-sort-3d-shapes': 2,
    },
    category: 'precise-topic',
    priority: 'high',
    description: 'Tests retrieval of Year 1 3D shapes content using curriculum terminology',
  },
  {
    query: 'properties of triangles KS1',
    expectedRelevance: {
      'explore-discuss-and-identify-shapes-that-are-and-are-not-triangles': 3,
      'identify-properties-of-triangles': 2,
    },
    category: 'precise-topic',
    priority: 'medium',
    description: 'Tests retrieval of KS1 triangle properties content using curriculum terminology',
  },
  {
    query: 'properties of rectangles KS1',
    expectedRelevance: {
    ...
    category: 'precise-topic',
    priority: 'medium',
    description: 'Tests retrieval of KS1 rectangle properties content using curriculum terminology',
  },
  {
    query: 'right angles Year 3',
    expectedRelevance: {
    ...
    category: 'precise-topic',
    priority: 'medium',
    description: 'Tests retrieval of Year 3 right angles content using curriculum terminology',
  },
  {
    ...
    category: 'precise-topic',
    priority: 'medium',
    description: 'Tests retrieval of quadrilateral properties content using curriculum terminology',
  },
  {
    ...
    expectedRelevance: {
      ...
      'shapes-with-the-same-areas-can-have-different-perimeters-and-vice-versa': 2,
    },
    category: 'precise-topic',
    priority: 'high',
    description: 'Tests retrieval of area and perimeter content using curriculum terminology',
  },
] as const;
