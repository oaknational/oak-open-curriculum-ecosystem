...
export const NUMBER_PRIMARY_QUERIES: readonly GroundTruthQuery[] = [
  {
    ...
    priority: 'high',
    description: 'Tests retrieval of Year 1 counting to 10 content using curriculum terminology',
  },
  {
    query: 'counting to 100',
    expectedRelevance: {
      'explore-the-counting-sequence-for-counting-to-100-and-beyond': 3,
      'counting-forwards-and-backwards-in-10s-to-100': 2,
    },
    category: 'precise-topic',
    priority: 'high',
    description: 'Tests retrieval of counting to 100 content using curriculum terminology',
  },
  {
  ...
  },
  {
    ...
    category: 'precise-topic',
    priority: 'high',
    description: 'Tests retrieval of column addition content using curriculum terminology',
  },
  {
    ...
    category: 'precise-topic',
    priority: 'high',
    description: 'Tests retrieval of number bonds to 10 content using curriculum terminology',
  },
  {
    ...
    category: 'precise-topic',
    priority: 'medium',
    description: 'Tests retrieval of bridging through 10 content using curriculum terminology',
  },
  {
    ...
    category: 'precise-topic',
    priority: 'medium',
    description: 'Tests retrieval of 4-digit rounding content using curriculum terminology',
  },
  {
    query: 'part whole model addition',
    expectedRelevance: {
      'explain-how-a-combination-of-different-parts-can-be-equivalent-to-the-same-whole': 3,
      'identify-the-missing-part-using-knowledge-of-relationships-and-structures': 2,
    },
    category: 'precise-topic',
    priority: 'medium',
    description: 'Tests retrieval of part-whole model content using curriculum terminology',
  },
] as const;
