/**
 * Hard ground truth queries for KS3 Science search.
 *
...
/**
 * Hard ground truth queries for KS3 Science.
 */
export const HARD_QUERIES_KS3_SCIENCE: readonly GroundTruthQuery[] = [
  // NATURALISTIC
  {
