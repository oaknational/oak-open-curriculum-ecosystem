/**
 * KS3 Science ground truth queries for Biology topics.
 *
 * Covers Year 7-9 Biology: cells, ecosystems, respiration, photosynthesis.
 *
...
/**
 * Biology ground truth queries for KS3 Science.
 */
export const BIOLOGY_KS3_QUERIES: readonly GroundTruthQuery[] = [
  {
