/**
 * KS3 Citizenship hard ground truth queries.
 *
...
/**
 * KS3 Citizenship hard queries (misspellings, synonyms, colloquial).
 */
export const CITIZENSHIP_KS3_HARD_QUERIES: readonly GroundTruthQuery[] = [
  {
