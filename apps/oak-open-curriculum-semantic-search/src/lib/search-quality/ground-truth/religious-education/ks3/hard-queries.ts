/**
 * Hard ground truth queries for KS3 Religious Education search.
 *
...
/**
 * Hard ground truth queries for KS3 RE.
 */
export const HARD_QUERIES_KS3_RE: readonly GroundTruthQuery[] = [
  // NATURALISTIC
  {
