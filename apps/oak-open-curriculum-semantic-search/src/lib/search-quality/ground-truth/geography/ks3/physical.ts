/**
 * KS3 Geography ground truth queries for Physical geography.
 *
...
/**
 * Physical geography ground truth queries for KS3.
 */
export const PHYSICAL_KS3_QUERIES: readonly GroundTruthQuery[] = [
  {
