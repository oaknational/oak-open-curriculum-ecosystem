/**
 * Hard ground truth queries for KS3 Geography search.
 *
...
/**
 * Hard ground truth queries for KS3 Geography.
 */
export const HARD_QUERIES_KS3_GEOGRAPHY: readonly GroundTruthQuery[] = [
  // NATURALISTIC
  {
