/**
 * KS4 English ground truth queries for modern texts.
 *
...
/**
 * Modern text ground truth queries for KS4 English.
 *
 * Focus: An Inspector Calls, Animal Farm — themes, characters, context.
 */
export const MODERN_TEXTS_KS4_QUERIES: readonly GroundTruthQuery[] = [
  {
