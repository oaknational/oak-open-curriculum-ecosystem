/**
 * KS3 French ground truth queries for grammar topics.
 *
...
/**
 * Grammar ground truth queries for KS3 French.
 */
export const GRAMMAR_KS3_FRENCH: readonly GroundTruthQuery[] = [
  {
