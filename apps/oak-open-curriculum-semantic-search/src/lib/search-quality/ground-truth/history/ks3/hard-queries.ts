/**
 * Hard ground truth queries for KS3 History search.
 *
...
/**
 * Hard ground truth queries for KS3 History.
 */
export const HARD_QUERIES_KS3_HISTORY: readonly GroundTruthQuery[] = [
  // NATURALISTIC
  {
