/**
 * KS3 History ground truth queries for Medieval history.
 *
...
/**
 * Medieval history ground truth queries for KS3.
 */
export const MEDIEVAL_KS3_QUERIES: readonly GroundTruthQuery[] = [
  {
