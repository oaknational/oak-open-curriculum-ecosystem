...
type SuggestionCache = SearchSuggestionResponse['cache'];
...
export interface BuildMultiScopeFixtureOptions {
  ...
  readonly overrides?: {
    readonly suggestions?: SearchSuggestionItem[];
...
function collectSuggestions(
  defaults: readonly SearchSuggestionItem[],
  overrides?: SearchSuggestionItem[],
...
function finalizeMultiScopeFixture(response: SearchMultiScopeResponse): SearchMultiScopeResponse & {
  suggestions: SearchSuggestionItem[];
  suggestionCache: SuggestionCache;
} {
  return {
