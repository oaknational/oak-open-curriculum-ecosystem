...
export function renderLoadingResults(
  ...
  summarySkeleton: JSX.Element,
  resultsSkeleton: JSX.Element,
): JSX.Element {
  return (
    <ResultsSection
      as="section"
...
export function renderIdleResults(sectionId?: string): JSX.Element {
  return (
    <ResultsSection
      as="section"
      id={sectionId}
...
export function renderMultiScopeResults(
  sectionId: string | undefined,
