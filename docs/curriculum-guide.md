...
> [Data Variances](data/DATA-VARIANCES.md) for details.
...
(see [VISION.md](VISION.md) for methodology). This is the result of combining
...
[AI Agent Guide](agent-guidance/ai-agent-guide.md).
...
- [Data Variances](data/DATA-VARIANCES.md) — detailed technical reference for
  subject/key stage differences, transcript availability, and structural
  patterns
- [VISION.md](VISION.md) — why this repository exists and how we measure
  impact
