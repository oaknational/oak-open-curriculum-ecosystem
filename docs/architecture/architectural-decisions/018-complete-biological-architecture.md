...
- Complex Systems Research Summary (2021-2025) - See `.agent/research/complex-systems-dynamics/` (originally relocated 2026-04-22 from `.agent/reference/complex-systems-dynamics/` per PDR-032; re-homed to `.agent/research/complex-systems-dynamics/` during the Session 8 rehoming pass)
