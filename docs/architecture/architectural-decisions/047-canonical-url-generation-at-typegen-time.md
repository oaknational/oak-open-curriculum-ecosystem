# ADR-047: Canonical URL Generation at Type-Gen Time
...
**Generate canonical URL helpers at type-generation time and automatically augment all API responses with canonical URLs.**

### Implementation Strategy

1. **Type-Gen Time Generation**: URL helpers are generated during the SDK's type generation pipeline (`pnpm type-gen`)
...
2. `pnpm type-gen` - Type generation successful
...
- [ADR-026: OpenAPI Type Generation Strategy](026-openapi-type-generation-strategy.md) - Type generation from OpenAPI
