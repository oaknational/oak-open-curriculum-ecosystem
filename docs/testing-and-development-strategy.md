...
- Behaviour Driven Development (BDD): Write integration, and API tests before writing code. Acceptance tests PROVE we are creating the **desired behaviour and impact** at the integration point level and above.
