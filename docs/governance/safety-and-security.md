...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| **DNS**                     | **No application-layer Host validation is mounted today.** The `dnsRebindingProtection` guard is retained and tested but mounted on no route: its only two mount points were the HTML surfaces, removed 2026-08-20. MCP-650 owns remounting it on `POST /mcp`. | **Currently unmitigated at this layer** — the edge layers below are the only Host controls until MCP-650 lands |
