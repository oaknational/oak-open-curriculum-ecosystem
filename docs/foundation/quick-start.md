...
open packages/sdks/oak-curriculum-sdk/docs/api/index.html
```
...
5. **Observability**: [MCP server observability wiring](../../apps/oak-curriculum-mcp-streamable-http/docs/observability.md), [Sentry Node library reference](../../packages/libs/sentry-node/README.md), [Sentry deployment runbook](../operations/sentry-deployment-runbook.md), [Sentry CLI usage](../operations/sentry-cli-usage.md), [ADR-143](../architecture/architectural-decisions/143-coherent-structured-fan-out-for-observability.md), [ADR-159](../architecture/architectural-decisions/159-per-workspace-vendor-cli-ownership.md), [ADR-160](../architecture/architectural-decisions/160-non-bypassable-redaction-barrier-as-principle.md), [ADR-162](../architecture/architectural-decisions/162-observability-first.md)
...
- **Issues**: [GitHub Issues](https://github.com/oaknational/oak-open-curriculum-ecosystem/issues)
- **Discussions**: [GitHub Discussions](https://github.com/oaknational/oak-open-curriculum-ecosystem/discussions)
