...
| Date       | Change                                                                                                                                                                             |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-02-25 | Updated canonical source links for property graph and API schema artefacts, standardised KS4 wording to `ks4Options`, and replaced volatile plan link with stable index references |
