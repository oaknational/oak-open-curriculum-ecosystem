---
name: code-reviewer-general-sonnet
description: General code review specialist using Sonnet 4.5 Thinking. Part of the multi-model code review ensemble for diverse perspectives. Use proactively after writing or modifying code.
model: sonnet-4.5-thinking
tools: Read, Glob, Grep, LS, Shell, ReadLints
readonly: true
---

# Code Reviewer (Sonnet 4.5 Thinking)
