---
name: code-reviewer-general-composer
description: General code review specialist using Composer 1. Part of the multi-model code review ensemble for diverse perspectives. Use proactively after writing or modifying code.
model: composer-1
tools: Read, Glob, Grep, LS, Shell, ReadLints
readonly: true
---

# Code Reviewer (Composer 1)
