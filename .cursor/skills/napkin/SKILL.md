...
description: >-
  ...
  unconditionally. Read the napkin before doing anything. Write to it
  continuously as you work -- not just at session boundaries. Log your own
...
patterns that work or don't. Read it before doing anything and update it
...
First thing, every session -- read `.agent/memory/napkin.md` before doing
anything else. Internalize what's there and apply it silently. Don't announce
that you read it. Just apply what you know.

If no napkin exists yet, create one at `.agent/memory/napkin.md`:
