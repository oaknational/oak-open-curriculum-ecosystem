...
const name= 'oak-get-lessons-summary' as const;
const path= '/lessons/{lesson}/summary' as const;
const method= 'GET' as const;

type Client = OakApiPathBasedClient['/lessons/{lesson}/summary']['GET'];
...
const executor= (client: OakApiPathBasedClient, requestParams: ValidRequestParams): ReturnType<Client> => {
  ...
  return client['/lessons/{lesson}/summary']['GET']({
    params: {
...
export const oakGetLessonsSummary = {
  name,
  path,
  method,
  operationId,
