/**
 * Generate deterministic URL helper library for teachers-site Oak URLs.
 *
 ...
 *
 * The `oakUrl` is the direct, slug-based URL constructable from a template and the
 * resource's slug alone. It is distinct from the upstream's `canonicalUrl`, which
 * encodes full curriculum context (programme, unit, key stage, exam board).
 *
