...
export const toolMcpFlatInputSchema = z.strictObject({ lesson: z.string().describe("The slug of the lesson").meta({ examples: ["checking-understanding-of-basic-transformations"] }) });
