...
export const toolMcpFlatInputSchema = z.strictObject({ keyStage: z.enum(["ks1", "ks2", "ks3", "ks4"] as const).describe("Key stage slug to filter by, e.g. 'ks2' - note that casing is important here, and should be lowercase").meta({ examples: ["ks1"] }), subject: z.enum(["art", "citizenship", "computing", "cooking-nutrition", "design-technology", "english", "french", "geography", "german", "history", "maths", "music", "physical-education", "religious-education", "rshe-pshe", "science", "spanish"] as const).describe("Subject slug to search by, e.g. 'science' - note that casing is important here").meta({ examples: ["art"] }), offset: z.preprocess((val) => typeof val === 'string' && /^-?\d+(\.\d+)?$/.test(val) ? Number(val) : val, z.number()).describe("If limiting results returned, this allows you to return the next set of results, starting at the given offset point").meta({ examples: [11] }).optional(), limit: z.preprocess((val) => typeof val === 'string' && /^-?\d+(\.\d+)?$/.test(val) ? Number(val) : val, z.number().lte(300)).describe("Limit the number of lessons, e.g. return a maximum of 300 lessons").meta({ examples: [10] }).optional(), filter: z.enum(["images"] as const).describe("Optional filter for question results. Use `images` to return only questions with a question image or image answer.").optional() });
export type ToolInputSchema = z.infer<typeof toolZodSchema>;
const toolArgsDescription = 'Invalid request parameters. Please match the following schema:\nSchema: {"type":"object","properties":{"keyStage":{"type":"string","description":"Key stage slug to filter by, e.g. \'ks2\' - note that casing is important here, and should be lowercase","examples":["ks1"],"enum":["ks1","ks2","ks3","ks4"]},"subject":{"type":"string","description":"Subject slug to search by, e.g. \'science\' - note that casing is important here","examples":["art"],"enum":["art","citizenship","computing","cooking-nutrition","design-technology","english","french","geography","german","history","maths","music","physical-education","religious-education","rshe-pshe","science","spanish"]},"offset":{"type":"number","description":"If limiting results returned, this allows you to return the next set of results, starting at the given offset point","default":0,"examples":[11]},"limit":{"type":"number","description":"Limit the number of lessons, e.g. return a maximum of 300 lessons","default":20,"examples":[10],"maximum":300},"filter":{"type":"string","description":"Optional filter for question results. Use `images` to return only questions with a question image or image answer.","enum":["images"]}},"additionalProperties":false,"required":["keyStage","subject"]}\nRequired: keyStage, subject';
