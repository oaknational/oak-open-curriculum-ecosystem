...
export const toolMcpFlatInputSchema = z.object({ lesson: z.string().describe("The lesson slug identifier").meta({ examples: ["imagining-you-are-the-characters-the-three-billy-goats-gruff"] }) });
