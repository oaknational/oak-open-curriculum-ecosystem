...
export const SearchLessonsIndexDocSchema = z
  .object({
    ...
    subject_slug: z.enum(ALL_SUBJECTS),
    subject_parent: z.enum(SUBJECTS),
    ...
    lesson_structure: z.string().min(1).optional(),
    lesson_content_semantic: z.string().min(1).optional(),
    lesson_structure_semantic: z.string().min(1).optional(),
    ...
    exam_board_titles: z.array(z.string().min(1)).optional(),
    exam_subjects: z.array(z.string().min(1)).optional(),
    exam_subject_titles: z.array(z.string().min(1)).optional(),
    ks4_options: z.array(z.string().min(1)).optional(),
    ks4_option_titles: z.array(z.string().min(1)).optional(),
...
export const SearchUnitsIndexDocSchema = z
  .object({
    ...
    why_this_why_now: z.string().min(1).optional(),
    categories: z.array(z.string().min(1)).optional(),
    prior_knowledge_requirements: z.array(z.string().min(1)).optional(),
    national_curriculum_content: z.array(z.string().min(1)).optional(),
    tiers: z.array(z.string().min(1)).optional(),
    tier_titles: z.array(z.string().min(1)).optional(),
    exam_boards: z.array(z.string().min(1)).optional(),
    exam_board_titles: z.array(z.string().min(1)).optional(),
...
export const SearchUnitRollupDocSchema = z
  .object({
    ...
    lesson_count: z.number().int().nonnegative(),
    unit_topics: z.array(z.string().min(1)).optional(),
    unit_content: z.string().min(1),
    unit_structure: z.string().min(1).optional(),
    unit_content_semantic: z.string().min(1).optional(),
    unit_structure_semantic: z.string().min(1).optional(),
    unit_url: z.string().min(1),
    subject_programmes_url: z.string().min(1),
    sequence_ids: z.array(z.string().min(1)).optional(),
    thread_slugs: z.array(z.string().min(1)).optional(),
