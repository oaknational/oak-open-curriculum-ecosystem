...
Ordering: units and lessons come in Oak's authored curriculum order — a unit's lessons are the sequence they are taught in, and a thread's units progress across years. Where the curriculum records no position for a lesson, it follows the ordered ones rather than sitting among them.
