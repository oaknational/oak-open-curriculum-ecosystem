...
const inputSchema = { type: 'object' as const, properties: {"subject":{"type":"string","description":"Subject slug to filter by"}} as const, additionalProperties: false as const, required: ["subject"] };
 ...
 */
export const getSubjectsYears: ToolDescriptor = {
  executor,
 ...
 */
export const getSubjectsYearsTool: OakMcpToolBase<unknown, unknown> = {
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/subjects/{subject}/years');
