...
const executor= (client: OakApiPathBasedClient) => {
  return async (params: ValidRequestParams): Promise<unknown> => {
    ...
    const ep = client["/lessons/{lesson}/summary"];
 ...
 */
export const getLessonsSummary: ToolDescriptor = {
  executor,
 ...
 */
export const getLessonsSummaryTool: OakMcpToolBase<unknown, unknown> = {
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/lessons/{lesson}/summary');
