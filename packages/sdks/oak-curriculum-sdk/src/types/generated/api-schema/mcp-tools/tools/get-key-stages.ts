 ...
 */
export const getKeyStages: ToolDescriptor = {
  executor,
 ...
 */
export const getKeyStagesTool: OakMcpToolBase<unknown, unknown> = {
  name: 'get-key-stages',
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/key-stages');
