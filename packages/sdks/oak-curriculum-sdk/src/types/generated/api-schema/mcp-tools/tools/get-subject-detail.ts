...
const executor= (client: OakApiPathBasedClient) => {
  return async (params: ValidRequestParams): Promise<unknown> => {
    ...
    const ep = client["/subjects/{subject}"];
 ...
 */
export const getSubjectDetail: ToolDescriptor = {
  executor,
 ...
 */
export const getSubjectDetailTool: OakMcpToolBase<unknown, unknown> = {
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/subjects/{subject}');
