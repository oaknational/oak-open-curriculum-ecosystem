...
const inputSchema = { type: 'object' as const, properties: {"lesson":{"type":"string","description":"The lesson slug identifier"}} as const, additionalProperties: false as const, required: ["lesson"] };
 ...
 */
export const getLessonsQuiz: ToolDescriptor = {
  executor,
 ...
 */
export const getLessonsQuizTool: OakMcpToolBase<unknown, unknown> = {
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/lessons/{lesson}/quiz');
