 ...
 */
export const getSubjects: ToolDescriptor = {
  executor,
 ...
 */
export const getSubjectsTool: OakMcpToolBase<unknown, unknown> = {
  name: 'get-subjects',
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/subjects');
