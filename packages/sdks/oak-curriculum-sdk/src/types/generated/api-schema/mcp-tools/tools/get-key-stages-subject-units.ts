 ...
 */
export const getKeyStagesSubjectUnits: ToolDescriptor = {
  executor,
 ...
 */
export const getKeyStagesSubjectUnitsTool: OakMcpToolBase<unknown, unknown> = {
  ...
  validateInput: (input: unknown) => {
    const result = z.object({ path: z.object({ keyStage: z.union([z.literal("ks1"), z.literal("ks2"), z.literal("ks3"), z.literal("ks4")]), subject: z.union([z.literal("art"), z.literal("citizenship"), z.literal("computing"), z.literal("cooking-nutrition"), z.literal("design-technology"), z.literal("english"), z.literal("french"), z.literal("geography"), z.literal("german"), z.literal("history"), z.literal("maths"), z.literal("music"), z.literal("physical-education"), z.literal("religious-education"), z.literal("rshe-pshe"), z.literal("science"), z.literal("spanish")]) }) }).safeParse(input);
    if (result.success) {
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/key-stages/{keyStage}/subject/{subject}/units');
