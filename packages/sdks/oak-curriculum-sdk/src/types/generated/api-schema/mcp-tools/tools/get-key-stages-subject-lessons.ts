 ...
 */
export const getKeyStagesSubjectLessons: ToolDescriptor = {
  executor,
 ...
 */
export const getKeyStagesSubjectLessonsTool: OakMcpToolBase<unknown, unknown> = {
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/key-stages/{keyStage}/subject/{subject}/lessons');
