 ...
 */
export const getThreads: ToolDescriptor = {
  executor,
 ...
 */
export const getThreadsTool: OakMcpToolBase<unknown, unknown> = {
  name: 'get-threads',
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/threads');
