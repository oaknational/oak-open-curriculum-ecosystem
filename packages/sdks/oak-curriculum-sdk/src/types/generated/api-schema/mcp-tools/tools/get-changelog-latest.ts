 ...
 */
export const getChangelogLatest: ToolDescriptor = {
  executor,
 ...
 */
export const getChangelogLatestTool: OakMcpToolBase<unknown, unknown> = {
  ...
  validateOutput: (data: unknown) => {
    const schema: ZodSchema = getResponseSchemaForEndpoint('get', '/changelog/latest');
