 ...
 *
 * **Cardinal Rule Compliance**: These definitions flow to generated code at type-gen time.
 * Running `pnpm type-gen` regenerates all dependent schemas and mappings.
 *
 * @example
 * ```typescript
