...
export function generateRootIndexFile(): string {
  return [
    ...
    'export { type ToolArgs, type ToolArgsForOperationId, type ToolDescriptors, type ToolInvoke, type ToolNameFromOperationId, type ToolOperationIdForName, type ToolResult, type ToolResultForOperationId, type RegisteredToolEntries, type ToolClient, type ToolClientForName, type ToolArgsForName, type ToolResultForName } from "./generated/aliases/types.js";',
  ].join('\n\n');
}
