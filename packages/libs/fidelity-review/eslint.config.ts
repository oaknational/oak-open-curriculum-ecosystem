/**
 * ESLint Configuration for the fidelity-review library
 *
 * Shared fidelity capture/diff/report core for the demo apps.
 */
...
const config = defineConfigArray(
  ...
  configs.strict,
  {
    ...
    rules: createLibBoundaryRules('fidelity-review'),
  },
  {
