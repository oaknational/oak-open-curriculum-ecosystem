...
export const APP_AUTH_DELTA_REVIEWS: Readonly<Record<string, CurrentSourceDeltaReview>> = {
  ...
  // MCP-143 PR-4: threads `authorizedParties` from runtime config into the
  // `clerkMiddleware` option bag (Guard 1c). Config plumbing only; no served
  // content changes.
  'apps/oak-curriculum-mcp-streamable-http/src/global-auth-context.ts': excluded(
    '36b6024723f7f456fa1d9814a548e396d356051e8c503d2e0deede55d66313c7',
    IMPLEMENTATION_ONLY,
  ),
