...
| [`skill-composition.md`](skill-composition.md) | Resonance estate import (PDR-125 exchange) | **Substantiated** by the source estate's worked hierarchy plus this estate's same-day live use (the wrap-family skills declare their places in it). **Justified as reference, not research**: names the skill-composition hierarchy and its two architectural rules — read-to-learn material consulted when authoring or wiring any skill. **Justified as evergreen**: the composition model is independent of any single skill's content. **Owner-vetted**: the 2026-07-20 12:49Z owner directive imported "everything referenced in the wrap skill, and the wrap skill itself" — this document is in that closed graph by the owner's own scope word. |
| [`cross-machine-collaboration.md`](cross-machine-collaboration.md) | 2026-07-20 cross-machine session capture | **Substantiated** by the worked instance (the Deimos remote seat: SSH bridge + deterministic-seed identity + remote comms via the checkout CLI). **Justified as reference, not research**: the repeatable mechanism for adding a cross-machine seat — consulted at each future remote-seat setup. **Justified as evergreen**: the mechanism rests on stable primitives (SSH, the identity CLI's seed derivation), not any one machine. **Owner-vetted**: the channel and the remote seat were owner-provisioned and owner-sanctioned in the 2026-07-20 session (the owner keyed the SSH access and directed the seat's use). |
| [`arc-rapid-communication.md`](arc-rapid-communication.md) | live ARC experiment channel | **Substantiated** in the live ARC channel across four arcs (2026-05-27 → 2026-06-11), conserved verbatim in the tracked transcript backup `.agent/state/collaboration/sidebars/2026-06-11-arc-channel-transcript-backup.md`. **Justified as reference, not research**: protocol and conventions consulted at every channel open (read-to-learn material for rapid peer dialogue); evaluation evidence rides along to ground the conventions. **Justified as evergreen**: the append-only/tail contract and conventions are independent of any single channel or pairing; mechanism-level evolution is trigger-gated inside the doc. **Owner-vetted**: 2026-06-11 owner-directed conservation of all ARC knowledge to tracked files. |
| [`grammar-of-thinking.md`](grammar-of-thinking.md) | `research/agentic-engineering/` | **Substantiated** in research, refined in-session and re-aimed for the agent-as-thinker. **Justified as reference, not research**: the depth reference behind the `oak-reason` skill and the yardstick for complex/high-stakes reasoning — read-to-learn material consulted when structuring analysis, planning, or decisions; not exploratory synthesis. **Justified as evergreen**: a general reasoning grammar, independent of any stack, product, or repo. **Owner-vetted**: 2026-06-22 owner-directed promotion and re-aim. |
