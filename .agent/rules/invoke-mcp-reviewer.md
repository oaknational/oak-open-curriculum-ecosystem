...
See `.agent/directives/invoke-code-reviewers.md` for the full reviewer catalogue and invocation policy. The `mcp-reviewer` canonical template is at `.agent/sub-agents/templates/mcp-reviewer.md`.
