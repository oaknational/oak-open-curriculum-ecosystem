...
| `.agent/skills/knowledge/consolidate-docs/SKILL-CANONICAL.md` | 204, 247, 269 | Same "comms-events" term as both directory name and event class | **update** — same disambiguation as session-handoff | WS4 |
