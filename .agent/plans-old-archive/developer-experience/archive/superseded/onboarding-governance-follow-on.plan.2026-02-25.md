...
- [ ] **B1. Add cost model/sustainability framing to foundation/VISION.md**
  - Audiences: CTO, CEO
...
- [ ] **B3. Add "Risks and Mitigations" to foundation/VISION.md (business terms)**
  - Audiences: CEO, CTO
...
|---|---|
| B1 | CTO P1: foundation/VISION.md lacks cost model/sustainability |
...
| `docs-adr-reviewer` | B1, B3, B5 (foundation/VISION.md structural improvements, strategy articulation) |
