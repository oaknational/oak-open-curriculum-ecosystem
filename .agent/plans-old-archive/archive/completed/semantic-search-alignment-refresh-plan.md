...
- Plans and docs describe processes that honour `.agent/directives/principles.md` and `.agent/directives/testing-strategy.md`, including TDD expectations, quality gates, and documentation standards.
