...
- Must comply with `.agent/directives/principles.md` (Cardinal type rule, no type shortcuts, British spelling) and `.agent/directives/testing-strategy.md` (TDD-first, behaviour-focused proofs).
