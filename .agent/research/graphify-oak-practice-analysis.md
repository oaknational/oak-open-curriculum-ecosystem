...
- [`.agent/plans/connecting-oak-resources/knowledge-graph-integration/active/open-education-knowledge-surfaces.plan.md`](../plans/connecting-oak-resources/knowledge-graph-integration/active/open-education-knowledge-surfaces.plan.md)
- [`.agent/plans/connecting-oak-resources/knowledge-graph-integration/active/graph-resource-factory.plan.md`](../plans/connecting-oak-resources/knowledge-graph-integration/active/graph-resource-factory.plan.md)
- [`.agent/plans/connecting-oak-resources/knowledge-graph-integration/active/misconception-graph-mcp-surface.plan.md`](../plans/connecting-oak-resources/knowledge-graph-integration/active/misconception-graph-mcp-surface.plan.md)
