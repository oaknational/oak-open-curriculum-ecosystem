...
apps/oak-open-curriculum-semantic-search/app/api/search/route.integration.test.ts
...
apps/oak-open-curriculum-semantic-search/app/api/docs/page.integration.test.tsx
...
apps/oak-open-curriculum-semantic-search/app/ui/search/natural/NaturalSearch.unit.test.tsx
apps/oak-open-curriculum-semantic-search/src/lib/observability/api/zero-hit-api.unit.test.ts
apps/oak-open-curriculum-semantic-search/app/api/search/nl/route.integration.test.ts
...
apps/oak-open-curriculum-semantic-search/app/api/observability/zero-hit/route.integration.test.ts
packages/sdks/oak-curriculum-sdk/type-gen/zodgen-core.unit.test.ts
apps/oak-open-curriculum-semantic-search/src/lib/observability/zero-hit.unit.test.ts
apps/oak-open-curriculum-semantic-search/app/layout.meta.unit.test.ts
...
apps/oak-open-curriculum-semantic-search/app/api/admin/fixtures.integration.test.ts
apps/oak-open-curriculum-semantic-search/tests/app/layout.ssr-cookie.integration.test.tsx
packages/sdks/oak-curriculum-sdk/type-gen/zodgen-core.integration.test.ts
apps/oak-open-curriculum-semantic-search/app/lib/registry.unit.test.tsx
apps/oak-open-curriculum-semantic-search/app/api/search/suggest/route.integration.test.ts
packages/sdks/oak-curriculum-sdk/src/mcp/universal-tools.unit.test.ts
apps/oak-open-curriculum-semantic-search/src/lib/observability/zero-hit-persistence.unit.test.ts
apps/oak-open-curriculum-semantic-search/src/lib/hybrid-search/index.unit.test.ts
apps/oak-curriculum-mcp-streamable-http/e2e-tests/tool-call-success.e2e.test.ts
apps/oak-open-curriculum-semantic-search/app/ui/global/Header/Header.integration.test.tsx
apps/oak-open-curriculum-semantic-search/src/lib/elastic-http.unit.test.ts
```
