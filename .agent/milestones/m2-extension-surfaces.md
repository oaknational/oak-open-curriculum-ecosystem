...
infrastructure, and initial knowledge graph alignment — the foundations
needed before the service can open to the public. Production authentication
is deferred to M3; the dev Clerk instance remains in place.
...
MCP Apps migration execution plan
exists. KG alignment audit promoted to active plan.
