...
| Graduated authority | Contextual authority that changes with situation, evidence, or risk | Would improve escalation and tactical ownership design | precedence rules and reviewer escalation hints | missing | future plan |
...
| Adoption ladder | Minimal-to-full uptake path for new mechanism families | Makes rollout proportional and evidence-led | strategic/current/active plan lifecycle, but not concept-specific | missing | future plan |
