...
- `repo-search-deep-dive.md`
  - Deep dive on the repo search stack (SDK/CLI focus), indexing, hybrid querying, suggestions, NL parsing, caching, observability, and evaluation.
- `feature-comparison-legacy-vs-repo.md`
  - Capability comparison, gap matrix, matching steps, and outshine opportunities.
...
1. `legacy-search-report.md`
2. `repo-search-deep-dive.md`
3. `feature-comparison-legacy-vs-repo.md`
4. `request-response-examples.md`
5. `feature-goals-roadmap-alignment.md`
