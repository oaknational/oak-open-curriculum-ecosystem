...
- `WS-4` refers to the fourth workstream in
   [open-education-knowledge-surfaces.plan.md](../plans/connecting-oak-resources/knowledge-graph-integration/active/open-education-knowledge-surfaces.plan.md),
...
| [open-education-knowledge-surfaces.plan.md](../plans/connecting-oak-resources/knowledge-graph-integration/active/open-education-knowledge-surfaces.plan.md) | MCP umbrella for multi-source surfaces | WS-4 should widen from one taxonomy slice to a small official ontology surface family |
| [nc-knowledge-taxonomy-surface.plan.md](../plans/connecting-oak-resources/knowledge-graph-integration/active/nc-knowledge-taxonomy-surface.plan.md) | First safe MCP ontology slice | Still valid, but too narrow to stand alone as "the ontology integration plan" |
...
| Plan | Recommendation |
| --- | --- |
| [open-education-knowledge-surfaces.plan.md](../plans/connecting-oak-resources/knowledge-graph-integration/active/open-education-knowledge-surfaces.plan.md) | **Leave alone.** WS-4 scope is appropriate for a first integration. The wider `oak-kg-*` family recommended in this report naturally follows as WS-4 proves the pattern. |
