...
description: Learn what machine authentication is, why it's used, and how it
  works with Clerk.
lastUpdated: 2025-10-24T23:09:59.000Z
sdkScoped: 'false'
canonical: /docs/guides/development/machine-auth/overview
sourceFile: /docs/guides/development/machine-auth/overview.mdx
---
...
If you'd like for your application's users to be able to create API keys that can delegate access to your application's API on their behalf, this is the intended use case for Clerk's API keys feature. With this feature, you will be able to allow users to create API keys directly through <SDKLink href="/docs/:sdk:/reference/components/user/user-profile" sdks={["astro","chrome-extension","expo","nextjs","nuxt","react","react-router","remix","tanstack-react-start","vue","js-frontend"]}>the `<UserProfile />` component</SDKLink>, or create your own UI for API keys via custom hooks. It will also be simple to verify API keys on your backend using Clerk's SDKs, and you or your users will be able to instantly revoke API keys at any time.
