...
- **Directives and rules** (`.agent/directives/`) — 5 directive documents governing all work: AGENT.md (entry point), rules.md (operational rules), testing-strategy.md, schema-first-execution.md, metacognition.md. Operational rule reinforcements in `.agent/rules/`. Domain-specific architecture guidance in `docs/agent-guidance/` (e.g. semantic-search-architecture.md)
