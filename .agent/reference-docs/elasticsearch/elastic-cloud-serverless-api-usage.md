---
title: Manage serverless projects using the API
description: On this page, you can find examples of how to create and manage serverless projects using the Elastic Cloud Serverless API. To learn about API principles,...
url: https://www.elastic.co/docs/deploy-manage/deploy/elastic-cloud/manage-serverless-projects-using-api
---
...
To try the examples in this section, [set up an API key](#general-manage-project-with-api-set-up-api-key) and [create an Elastic Cloud Serverless project](#general-manage-project-with-api-create-a-serverless-elasticsearch-project).
...
- [Manage serverless projects using the API](#manage-serverless-projects-using-the-api)
  - [Set up an API key](#set-up-an-api-key)
  - [Create an Elastic Cloud Serverless project](#create-an-elastic-cloud-serverless-project)
