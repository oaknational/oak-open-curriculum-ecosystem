...
- **Tracking artefacts** (the per-lane documentation-sync-log in `.agent/memory/operational/documentation-sync-logs/`, `evidence/`):
...
Also apply:
[`oak-consolidate-docs`](../../skills/knowledge/consolidate-docs/SKILL-CANONICAL.md)
