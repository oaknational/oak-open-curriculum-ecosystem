...
- **Causal mechanism**: pandoc widens narrow table-separator rows to
  ...
  `<scratch>/kg-norm/`; if this becomes a recurring need, lift it into a
...
- Reframed `.agent/plans/connecting-oak-resources/knowledge-graph-integration/README.md` so the
