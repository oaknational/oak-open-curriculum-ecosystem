...
(Late capture, committed 2026-08-18: this entry predates the 2026-08-14 rotation —
it sat uncommitted in the Windows-native checkout working tree until this commit. It
belongs to the pre-rotation window; carried across the rotation per semantic-merge union.)
