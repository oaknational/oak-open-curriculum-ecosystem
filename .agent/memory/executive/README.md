...
| [`agent-capability-vocabulary.md`](agent-capability-vocabulary.md) | Audience and governance vocabulary for repo-working skills, Oak developer capabilities, and curriculum assistance capabilities | Naming or placing agent-readable knowledge, plugin content, MCP guidance, or curriculum assistance surfaces |
