...
- **Drift Detection Test** -- Use this when: a manually maintained list should match a canonical source but cannot be derived due to structural constraints. → [drift-detection-test.md](drift-detection-test.md)
