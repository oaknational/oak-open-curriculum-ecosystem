...
Each verified absent from this register before adding.
...
- **Client-visibility check belongs in MCP tool-shape ratification.** A
  ...
  structuredContent (S0 probe) | size: S | status: overdue]`
...
- **Agent-tools collaboration-CLI optional residuals (conserved 2026-06-12 from a
  ...
  owner-directed) | trigger: owner direction | size: S | status: overdue]`
...
- **"Tests pass" ≠ "the feature works" — run the assembled system, don't flag the gap.** Owner:
  ...
  exercised" instance, or the next handoff revising ADR-150 | size: S | status: overdue]`
...
- **Generalise "feedback mechanisms carry positive reappraisal direction" across every
  ...
  2026-06-07 | size: M | status: overdue]`
...
- **NEW pattern candidate:** *compile-time enforcement that a feedback surface teaches the positive
  ...
  pattern record at second consumer | size: M | status: overdue]`
...
- **Shared-window handoffs should scan for convergence, not only collision.** A
  ...
  second shared-window convergence instance | size: S | status: overdue]`
- **No-commit sessions need owner-visible proof for untracked artefacts.** A
  ...
  owner-invisible untracked artefact incident | size: S | status: overdue]`
- **Projection provenance for data-as-source-of-truth work.** A hand-authored
  ...
  hand-authored-mirror/codegen drift instance | size: S | status: overdue]`
- **Mechanical sweep and broad revert actions need set-level disposition before
  ...
  text-sweep/revert pass | size: M | status: overdue]`
- **Dependency refreshes need plan-truth cleanup.** Workspace dependency updates
  ...
  workspace-wide dependency refresh | size: S | status: overdue]`
...
- **A structural detector or output-time review pass for the negation-contrast form
  ...
  owner direction OR a viable low-false-positive detector design | size: M | status: overdue]`
...
- **Find the falsifying fact before product surgery.**
  ...
  direction | size: S | status: overdue]`
...
- **Plan narrative sections drift from working artefacts.**
  ...
  different state or owner direction | size: S | status: overdue]`
...
- **Fixed canonical data is authority; derive, do not validate.**
  ...
  owner direction | size: M | status: overdue]`
...
- **Read the primary artefact before machinery or reviewers.**
  ...
  owner direction | size: S | status: overdue]`
...
- **Recorded verdicts are claims to test, not frames to inherit.**
  ...
  or owner direction | size: S | status: overdue]`
...
- **Proportionate exploration — raising a question is fine; the expenditure is the failure.**
  ...
  stability) | size: S | status: overdue]`
...
## Legacy Backlog (overdue decision-debt)

Every item below is overdue — it has sat undecided past the empty-buffer target.
Decide each: graduate or reject, never leave it. The count is reported by the
decision-debt metric (`pnpm practice:fitness`).
...
- 2026-05-12; **Deferral with retrospective-review tripwire**.
  ...
  owner-direction-or-second-cross-increment-deferral | size: S | status: overdue]`
...
- 2026-05-12; **E-1/E-2 advisory hooks and agent-tools git passthrough**.
  ...
  owner-direction-or-decision-complete-scoping | size: L | status: overdue]`
...
- 2026-05-12; **Agent-tools CLI architectural decision extraction**.
  ...
  owner-direction-or-retrospective-confirms-doctrine | size: XL | status: overdue]`
...
- 2026-05-10; **Generated insight artefact decay/honesty discipline**.
  ...
  owner-direction-or-second-generated-insight-artefact | size: S | status: overdue]`
...
- 2026-05-05-06; **Cross-thread git-history as observable coordination
  ...
  owner-direction-or-second-cross-thread-git-history-adaptation | size: S | status: overdue]`
...
- 2026-05-05-06; **In-flight consolidation workflow-gap patching**.
  ...
  owner-direction-or-second-in-session-workflow-gap-patch | size: S | status: overdue]`
...
- 2026-05-05-06; **Fat-baton handoff inline diagnostics**.
  ...
  owner-direction-or-second-named-receiver-diagnostic-handoff | size: S | status: overdue]`
...
- 2026-04-29; **Trinity Active Principles and bootstrap structural
  ...
  owner-approval-for-core-amendments | size: M | status: overdue]`
...
- 2026-04-29; **Open up the value early PDR decision**.
  ...
  owner-direction-or-fourth-cross-session-instance | size: S | status: overdue]`
...
- 2026-04-29; **Agent-infrastructure failure visibility Practice Core
  ...
  owner-direction-or-second-platform-thin-wrapper | size: S | status: overdue]`
...
- 2026-05-21; **Sync-kind / urgency flag in comms schema (ADR candidate)**.
  ...
  adr:184+implementation-tranches | trigger: implementation-lands | size: S | status: overdue]`
...
- 2026-05-13; **Coordinator role-label ontology residual**
  ...
  p1-falsification-evidence+owner-direction | size: S | status: overdue]`
...
- 2026-05-12; **Commit-boundary peer-pair governance refinements**
  ...
  n>=3-validation+owner-direction | size: L | status: overdue]`
...
second-instance | size: M | status: overdue]`
...
trigger: second-instance | size: S | status: overdue]`
...
trigger: candidate | size: L | status: overdue]`
...
split-by-attribution instance | size: M | status: overdue]`
...
surface — whichever first | size: S | status: overdue]`
...
single-session) | size: S | status: overdue]`
