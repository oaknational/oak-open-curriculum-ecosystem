...
| `Sandpiper lifts Downdraft` | `claude-code` | `Opus 4.8 (1M)` | `0c6576` | `curator — dedicated-consolidation: napkin rotated + 2 candidates conserved to pending-graduations; comms 317 heartbeats archive-moved; repo-continuity Current State curated to live-work-only (concluded arcs → verified homes, char 36.5k→22.5k); testing-strategy recipe pockets graduated to testing-patterns.md; negative-control pattern reconciled with the commit-skill reframe` | 2026-06-18 | 2026-06-18 |
