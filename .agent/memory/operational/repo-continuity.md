...
| `orientation-skills-family` | Teaching-surface family: a portable agentic-AI primer (lead-in) plus the repo-bound orientation lens(es) across the PDR-112 portability seam | [record][orientation] | claude-code / Opus 4.8 (1M) / Skipper tracks Reef / **REOPENED 2026-06-23** — owner-directed lens unification (two lenses → one intent-discerning lens; mode is a discerned variable; setup distinct; primer unchanged; PDR-112 NOT amended); plan queued at [`current/orientation-lens-unification.plan.md`](../../plans/developer-experience/current/orientation-lens-unification.plan.md); the primer+seam build is done (`5b3453d41`, push-pending) / 2026-06-23 (prior: Orbit rides Horizon, Bora lifts Downdraft) |
