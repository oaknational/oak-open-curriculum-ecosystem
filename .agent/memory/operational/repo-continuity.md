...
| --- | --- | --- | --- |
| `first-class-copilot-agent-participation` | First-class Copilot membership through native adapters over the canonical Practice; MCP-150 currently owns the strict hook boundary and single-evaluation dispatcher. Strategic and delivery nodes remain sketches pending owner ratification. | [record](threads/first-class-copilot-agent-participation.next-session.md) | codex / GPT-5 / Thistle holds Blossom (019f94) / implementer — plan-readiness and hook-boundary delivery / 2026-07-24 ← copilot / gpt-5.6-sol / Thistle rides Canopy (494337) / design authority and evidence author / 2026-07-24 |
