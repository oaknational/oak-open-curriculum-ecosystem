...
**Status (2026-05-17 — Solar Orbiting Asteroid / `claude` / Opus 4.7 (1M) /
...
**Prior status (2026-05-14 — Riverine Swimming Hull / `claude` / Opus 4.7 /
