...
### 2026-05-27 — Distilled hard-drain candidates

Active shard:
[`pending-graduations/2026-05-27-distilled-hard-drain-candidates.md`](pending-graduations/2026-05-27-distilled-hard-drain-candidates.md).

Route-state: split out by Hidden Dimming Threshold on 2026-05-27 while emptying
`distilled.md` as a drainable buffer. The shard carries two Airy Phase 0C
single-instance candidates: reviewer follow-on verdicts are information, not
authority; and structural evidence is not operational evidence. Process entry by
entry before removing this pointer.
