...
## Nested-bullet defect-class sweep — 2026-05-22 evening (Velvet Veiling Wisp)

This appended block carries the bodies of `status: graduated` entries that lived as nested bullets within enclosing ### sections in `pending-graduations.md`. These entries had their status flipped to graduated during the 2026-05-09 / 2026-05-10 / 2026-05-11 (Fronded Flowering Seed / Sylvan Fruiting Glade) consolidation passes, but their bodies were never moved to any archive snapshot — defect-class carry-forward from the prior consolidation pass, identified during this evening's backfill sweep and verified absent from `pending-graduations-archive-2026-05-10.md`. The live register replaces each entry with a one-line graduated-pointer; substance is preserved verbatim below.

### 2026-05-03 — Inter-agent collaboration protocol gaps surfaced under cross-vendor session
...
### 2026-05-02 — Observability orthogonal axes: ADR-171 + ADR-116/143/162/163 amendments
...
### 2026-05-02 — Invoke doc-and-onboarding experts on significant changes (rule)
...
### 2026-05-04 — No-moving-targets hook tightening (prose-vs-data distinction)
...
### 2026-05-05 — Agent-tools CLI affordance set + build isolation (PDR-055 + ADR-178)
...
### 2026-05-09 — Pre-commit gate scope (whole-tree vs staged-set) — completed P0 quality-gate rebalance
