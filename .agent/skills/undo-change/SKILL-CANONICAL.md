...
- Codex and other cross-tool runtimes:
  `.agents/skills/oak-undo-change/SKILL.md`
- Claude Code: `.claude/skills/oak-undo-change/SKILL.md`
...
adapters resolve to this canonical file through the `oak-` wrapper name.
