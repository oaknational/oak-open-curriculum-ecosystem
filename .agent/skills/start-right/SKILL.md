---
name: start-right
description: Apply the repository start-right grounding prompt to the active session. Use when the user asks to start right, re-ground work, or explicitly apply `.agent/prompts/start-right.prompt.md` and its linked directive documents before or during task execution.
---
...
Load `.agent/prompts/start-right.prompt.md` and enforce its directives in the current session before substantial work.

## Workflow

1. Read `.agent/prompts/start-right.prompt.md`.
