...
dispositions); plan revised post-Tier-1-reviewer-feedback (2026-04-24)
to collapse the dual-resolver design to a true single source of truth
in `@oaknational/build-metadata`, drop the WS3.5 dual-path hedge for a
single relocate-into-app path, and widen the atomic-replacement audit
scope. WS1 PRE-FLIGHT AUDIT is next.
