...
| [agent-skills-discovery-research.report.md](agent-skills-discovery-research.report.md) | Research synthesis for Agent Skills Discovery, MCP, A2A, and Oak mission/value implications | Research report | N/A |
| [skills-classification-taxonomy.plan.md](skills-classification-taxonomy.plan.md) | Apply the ADR-189 audience-led vocabulary (repo-working skills, Oak developer capabilities, curriculum assistance capabilities) across live docs, with platform `SKILL.md` packaging kept out of the conceptual model | Strategic | Owner-direct terminology pass, vocabulary drift, or a plugin/MCP guidance slice needing the taxonomy applied |
| [skills-distribution-channels-suggestions.report.md](skills-distribution-channels-suggestions.report.md) | Owner-supplied strategic report (2026-06-03) on Skills/MCP/plugin packaging, distribution channels, and suggested capability-pack directions; companion to the [taxonomy plan](skills-classification-taxonomy.plan.md) | Strategy report | N/A |
| [agent-skills-discovery.plan.md](agent-skills-discovery.plan.md) | Prepare Oak to publish a trusted Agent Skills Library through `.well-known/agent-skills/index.json` | Strategic / tracking | Catalogue ratification + trust model + RFC stability/publication decision |
