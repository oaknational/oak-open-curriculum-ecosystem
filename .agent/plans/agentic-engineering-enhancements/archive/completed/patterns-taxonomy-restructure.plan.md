...
todos:
  ...
  - id: reclassify-patterns
    content: Update category frontmatter in all 30 pattern files to use the new taxonomy
    status: completed
  - id: rename-skill
    content: Rename .agent/skills/code-patterns/ to .agent/skills/patterns/ and broaden trigger conditions
    status: completed
  - id: update-references
    content: "Update all files referencing code-patterns: consolidate-docs, artefact-inventory, practice-index, README, platform adapters, practice-context files, practice-core files, active plans"
    status: completed
  - id: validate
