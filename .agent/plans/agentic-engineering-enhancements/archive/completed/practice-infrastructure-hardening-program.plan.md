...
todos:
  - id: ws-1-pdr-075
    ...
    status: completed
  - id: ws-2-pdr-076
    content: "WS-2 — PDR-076 v2 Agent identity tuple + body-file frontmatter. Status: COMPLETED via SPLIT — PDR-076a (identity tuple name+UUID) LANDED at e8ca6d08 (tidy cycle 3); PDR-076b (body-file frontmatter contract) LANDED at b7ac9938 (tidy cycle 4). Cascade §2 body-file-adjacency overlap with §5 cured by partition. Gate 2 satisfied."
    status: completed
    depends_on: []
  - id: ws-3-adr-185
  ...
  - id: ws-6-marshal-cycle-discipline
    content: "WS-6 — Marshal-as-cycle-discipline. Status: COMPLETED — PDR-077 LANDED at 7c2f85f4 (tidy cycle 5) with role definition, cycle protocol, gate-singleton invariant, throughput observation, standing-duty intersection, PDR-063/PDR-064 §Related cross-references. Practice-index entries added at 93c4fdc0. Charcoal draft + R1/R3 syntheses captured at 4575044e (tidy cycle 2). All 7 R3 SHOULD-ABSORB items absorbed pre-landing per Charcoal+Lanternlit synthesis."
    status: completed
    depends_on: []
  - id: ws-7-pr-108-sonar-clearance
    content: "WS-7 — PR #108 SonarCloud + CodeQL quality-gate clearance. Status: COMPLETED — PR #108 MERGED at 2026-05-24T20:06:12Z via merge commit 2462952a957c69d4c614ddb95eb880c105839c1e (owner-confirmed 2026-05-25). SonarCloud + run-quality-gates flipped GREEN; EEF merge-path unblocked."
    status: completed
    depends_on: []
  - id: ws-8-architectural-direction-self-mod-authz
    content: "WS-8 — Architectural-direction ratification on Claude self-modification authorisation cure-shapes. Status: COMPLETED — ADR-187 LANDED at 7f7ad862 (tidy cycle 8a) codifying C2-near-term + C5-long-term + C4-fallback with C2-deferred-until-platform-support trigger."
    status: completed
    depends_on: []
  ...
  - id: ws-12-pdr-079-pdr-adr-portability
    content: "WS-12 — PDR-079 PDR-vs-ADR portability distinction. Status: COMPLETED — PDR-079 + co-cure rule scope-update LANDED at e8bc6781 (tidy cycle 5a) codifying PDRs as portable practice doctrine (no SHAs/repo-paths/branch-names) vs ADRs as repo-specific decisions (SHAs welcome); `.agent/rules/no-moving-targets-in-permanent-docs.md` scoped to portable surfaces only."
    status: completed
    depends_on: []
  - id: gate-safe-pause
    content: "M1 — Safe-Pause Milestone. Status: ACHIEVED 2026-05-24T20:09:10Z via Director attestation broadcast 2849b623-5026-4e9d-9938-7ebaffb727fd. All 5 gates held: Gate 1 WS-7 PR #108 merged 2462952a; Gate 2 WS-2 SPLIT (PDR-076a e8ca6d08 + PDR-076b b7ac9938); Gate 3 WS-5 pattern landed 8a99ed35; Gate 4 WS-9 cure landed 43e09287; Gate 5 queue terminal. Team pivoted focus to EEF First Feature lane."
    status: completed
    depends_on: [ws-2-pdr-076, ws-5-substrate-pointer-pattern, ws-7-pr-108-sonar-clearance, ws-9-twilit-fm2-p2-cure]
  - id: gate-complete
    content: "M2 — Completion Milestone. Status: ACHIEVED — M1 held (gate-safe-pause completed); WS-6 PDR-077 landed 7c2f85f4; WS-8 ADR-187 landed 7f7ad862; WS-11 heartbeat-doctrine bundle landed (PDR-078 9725ae09 + ADR-186 48c8ac22 + thin SKILL 9e57290d); WS-12 PDR-079 landed e8bc6781; next-window evidence base captured across the 2026-05-25 multi-agent arc (5 marshal-cycle landings observed without new substrate-stale-pointer instances). Program complete; remaining WS-10 (heartbeat-cron mechanism) + comms-watch storage redesign re-home per supersession mapping in archive README."
    status: completed
