...
| [multi-agent-collaboration-protocol.plan.md](multi-agent-collaboration-protocol.plan.md) | Adjacent: structural infrastructure for parallel agents (advisory, not enforcing; platform independent by design). WS0+WS1+WS2 landed; WS3A landed; narrow WS4A lifecycle integration implemented; WS3B and WS5 remain evidence/owner-gated | LIFECYCLE-INTEGRATION-COMPLETE |
| [multi-agent-collaboration-sidebar-and-escalation.plan.md](multi-agent-collaboration-sidebar-and-escalation.plan.md) | Split from WS3B: existing sidebar, timeout, and owner-escalation design preserved as a separate evidence-gated sibling | PAUSED-EVIDENCE-GATED |
...
recognise WS0-WS3A collaboration state. WS3B remains evidence-gated.
