...
- [auth-safety-correction.plan.md](../archive/auth-safety-correction.plan.md) — Archived/superseded on 5 March 2026; C8 is now a small fail-fast auth metadata invariant hardening task in [roadmap.md](../roadmap.md).
