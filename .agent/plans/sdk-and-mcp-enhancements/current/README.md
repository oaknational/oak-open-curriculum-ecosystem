...
| [auth-safety-correction.plan.md](auth-safety-correction.plan.md) | Correct auth safety drift and reassert MCP auth invariants in runtime and metadata projections | Not started |
