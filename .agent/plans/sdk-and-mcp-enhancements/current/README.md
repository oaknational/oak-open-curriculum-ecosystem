...
|---|---|---|
| [search-tool-text-to-query-rename.plan.md](search-tool-text-to-query-rename.plan.md) | Rename `text` → `query` on search and explore-topic MCP tools for LLM discoverability | Decision on Option A vs B |
