...
- `docs/agent-guidance/testing-strategy.md` - Test type definitions and boundaries
...
- ✅ Update `docs/agent-guidance/testing-strategy.md` with examples of correct E2E test patterns
