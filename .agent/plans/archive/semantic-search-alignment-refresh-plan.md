...
- Plans and docs describe processes that honour `.agent/directives-and-memory/rules.md` and `docs/agent-guidance/testing-strategy.md`, including TDD expectations, quality gates, and documentation standards.
