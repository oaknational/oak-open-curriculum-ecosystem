...
See [Upstream API Wishlist](../external/upstream-api-metadata-wishlist.md) for full details.
...
- [Phase 3](./phase-3-multi-index-and-fields.md) - Current work
- [Upstream API Wishlist](../external/upstream-api-metadata-wishlist.md) - Blocked features
