...
todos:
  - id: confirm-schema-browser-audience
    content: "Confirm whether the schema browser serves implementers, partner consumers, or teacher-facing agent workflows."
    status: pending
  - id: define-schema-response-shapes
    content: "Define class/property list, detail, examples, version pinning, and citation fields."
    status: pending
---
