...
todos:
  - id: define-topic-resolution-contract
    content: "Define how free-text topics resolve to ontology/thread/unit IRIs before any misconception sub-graph is returned."
    status: pending
  - id: define-ambiguity-and-budget-rules
    content: "Define ambiguity handling, response budgets, and citation requirements for topic-derived sub-graphs."
    status: pending
---
