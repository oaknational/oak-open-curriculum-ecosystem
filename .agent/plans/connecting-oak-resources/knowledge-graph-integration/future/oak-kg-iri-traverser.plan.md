...
todos:
  - id: prove-generic-traverser-need
    content: "Prove that a generic traverser is needed beyond named Thread, programme, lesson, or schema surfaces."
    status: pending
  - id: define-safety-bounds
    content: "Define traversal depth, response budget, cycle handling, and source-attribution requirements."
    status: pending
---
