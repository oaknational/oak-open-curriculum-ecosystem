...
| `pnpm test` (2025-10-24)                                                                                                                                                                                                               | ❌     | MCP tool generator unit tests still assert against the pre-refactor output (`emit-index`, `generate-lib-file`, `emit-error-description`, `emitters`, `mcp-tool-generator`). Downstream packages remain green.               |
