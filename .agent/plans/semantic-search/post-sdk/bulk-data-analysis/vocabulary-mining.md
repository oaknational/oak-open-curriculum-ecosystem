...
└── src/                    # Runtime code that consumes outputs
```
...
**Feeds into**: [definition-retrieval.md](definition-retrieval.md)
...
| [definition-retrieval.md](definition-retrieval.md) | Consumes definition data |
