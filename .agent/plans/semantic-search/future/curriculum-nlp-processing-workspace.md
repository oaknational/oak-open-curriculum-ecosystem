...
| [open-education-knowledge-surfaces.plan.md](../../connecting-oak-resources/knowledge-graph-integration/active/open-education-knowledge-surfaces.plan.md) | Parent coordination — outputs feed MCP surfaces |
