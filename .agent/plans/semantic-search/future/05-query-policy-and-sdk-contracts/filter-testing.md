...
# Add this script in Phase 1, then run:
pnpm tsx evaluation/analysis/audit-filter-dimensions.ts --subject maths --keyStage ks4
pnpm tsx evaluation/analysis/audit-filter-dimensions.ts --subject history --keyStage ks2
```
