...
| A5 | [short-term-pr-snagging.plan.md](./short-term-pr-snagging.plan.md) | Immediate PR snagging pass with evidence-first item triage, blocker-first fixes, and explicit thread closure outcomes | 🟡 Planning |
