...
> **Status**: COMPLETE — all A1-A8 workstreams implemented (23 February 2026)
>
...
- [x] **A1.1. Fix broken link to `institutional-memory.md` in README**
  - Files: `README.md`
...
- [x] **A1.3. Add `.nvmrc` file**
  - Files: `.nvmrc` (new)
  - Action: Create `.nvmrc` in repo root containing `24`.

- [x] **A1.4. Fix `.env.example` misleading comments**
  - Files: `.env.example`
...
- [x] **A1.6. Fix additional link and content errors**
...
- [x] **A7.1. ADR and link hygiene pass**
