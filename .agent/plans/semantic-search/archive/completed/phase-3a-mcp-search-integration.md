...
- `architecture-reviewer-barney` (and other architecture specialists as needed, including `architecture-reviewer-fred`, `architecture-reviewer-betty`, `architecture-reviewer-wilma`) on cross-SDK dependency and tool architecture
