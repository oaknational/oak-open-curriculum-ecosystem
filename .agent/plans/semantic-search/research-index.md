...
|---------|------|----------------|
| [Knowledge Graph Integration Hub](../connecting-oak-resources/knowledge-graph-integration/README.md) | Collection hub | Repo-wide entry point for ontology integration, direct-use baseline, platform comparison, and evidence/pedagogy sibling work |
...
| [Ontology Repo Fresh-Perspective Review](../connecting-oak-resources/knowledge-graph-integration/future/ontology-repo-fresh-perspective-review.plan.md) | Future short plan | Follow-on plan for an upstream-first re-read of the ontology repo that is not anchored only in semantic-search assumptions |
| [Direct Ontology Use and Graph Serving Prototypes](../connecting-oak-resources/knowledge-graph-integration/future/direct-ontology-use-and-graph-serving-prototypes.plan.md) | Future strategic plan | Tests whether direct ontology use is enough before Neo4j or Stardog is justified for search-adjacent workloads |
...
2. [Elasticsearch, Neo4j, and Oak Ontology Synthesis](../connecting-oak-resources/knowledge-graph-integration/research/elasticsearch-neo4j-oak-ontology-synthesis.research.md)
...
| [elasticsearch-neo4j-oak-ontology-synthesis.research.md](../connecting-oak-resources/knowledge-graph-integration/research/elasticsearch-neo4j-oak-ontology-synthesis.research.md) | Cross-cutting | Canonical synthesis of Elasticsearch, Neo4j, and ontology opportunities with real links | [../connecting-oak-resources/knowledge-graph-integration/oak-ontology-graph-opportunities.strategy.md](../connecting-oak-resources/knowledge-graph-integration/oak-ontology-graph-opportunities.strategy.md), graph-related promotion decisions |
...
|-------|------------------|---------------------|
| Search working with the ontology, with downstream graph serving as an earned option | [Elasticsearch, Neo4j, and Oak Ontology Synthesis](../connecting-oak-resources/knowledge-graph-integration/research/elasticsearch-neo4j-oak-ontology-synthesis.research.md) | [../connecting-oak-resources/knowledge-graph-integration/oak-ontology-graph-opportunities.strategy.md](../connecting-oak-resources/knowledge-graph-integration/oak-ontology-graph-opportunities.strategy.md) |
| Direct ontology use versus downstream graph-serving platforms | [RDF to Product: Neo4j and Stardog for Oak](../../research/kg-neo4j-stardog-product-creation/kg-neo4j-stardog-product-creation-clean.md) | [Direct Ontology Use and Graph Serving Prototypes](../connecting-oak-resources/knowledge-graph-integration/future/direct-ontology-use-and-graph-serving-prototypes.plan.md) |
