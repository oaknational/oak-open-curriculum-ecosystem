...
promoted into explicit execution plans when scheduled.
...
| [memory-state-contract-doctor.plan.md](memory-state-contract-doctor.plan.md) | Deterministic doctor for Practice state/memory surface contracts, generated read-model drift, canonical paths, and merge topology | QUEUED |
