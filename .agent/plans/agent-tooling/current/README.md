...
| [start-right-team-singleton-lane-remediation.plan.md](start-right-team-singleton-lane-remediation.plan.md) | First-pass remediation from the 2026-05-14 N-agent WS1 experiment: presence-before-source-claim, claim-overlap routing signals, canonical comms path ownership, stale-surface cleanup, and bulk-cleanup hot-window preflight. | FIRST-PASS / NOT DECISION-COMPLETE |
