...
> **Status**: Draft
> **Priority**: Medium
> **Foundation Documents**: [rules.md](../../directives-and-memory/rules.md), [testing-strategy.md](../../directives-and-memory/testing-strategy.md)
> **Research Sources**:
>
...
1. [rules.md](../../directives-and-memory/rules.md) — TDD, pure functions, no shortcuts
2. [testing-strategy.md](../../directives-and-memory/testing-strategy.md) — Test-first at all levels
3. [schema-first-execution.md](../../directives-and-memory/schema-first-execution.md) — For M2 (brief consolidation)
