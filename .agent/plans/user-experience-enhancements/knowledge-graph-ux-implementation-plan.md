...
1. **[rules.md](../../directives-and-memory/rules.md)** — Core development rules, TDD requirements, type safety
2. **[testing-strategy.md](../../directives-and-memory/testing-strategy.md)** — Test types, TDD at all levels, when to write tests
3. **[schema-first-execution.md](../../directives-and-memory/schema-first-execution.md)** — Generator-first mindset (applies to M2 if extended later)
