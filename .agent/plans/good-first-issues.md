...
- **Why this is a good first issue**: This repo's second value stream is the
  ...
  Three bounded shapes: walk `/oak-onboard-me` and file any friction you hit
...
3. Run [`/oak-start-right-quick`](../skills/start-right-quick/SKILL-CANONICAL.md)
   ...
   are brand new, [`/oak-onboard-me`](../skills/onboard-me/SKILL-CANONICAL.md)
   walks you here interactively.
