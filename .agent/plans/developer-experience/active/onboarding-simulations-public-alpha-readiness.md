...
**Status**: Active (post-remediation rerun complete; M0/M1 closed, M2 blockers tracked)
...
- [ ] **R9. G6 — Clerk production migration incomplete**
  ...
  - Classification: engineering/ops. Blocks M2 only.
...
| Governance items resolved or deferred | **PARTIAL** | **PARTIAL** | B1–B6 unchanged. R8 decided (add explanatory docs). R9/R10 reclassified to M2 blockers only |
...
private alpha). M2 (open public alpha) additionally requires Clerk (R9),
...
- **2026-02-26**: **Owner dispositions recorded for all 36 findings.** Key
  ...
  alpha → open private alpha (M0) → open public alpha (M2). R9 (Clerk),
  R10 (Sentry), R13 (rate limiting) reclassified to M2 blockers only.
