...
```env
# Required
ELASTICSEARCH_URL=https://...         # Elasticsearch Serverless endpoint
ELASTICSEARCH_API_KEY=...             # ES API key with index permissions
OAK_API_KEY=...                       # Oak Curriculum API key
SEARCH_API_KEY=...                    # Admin route authentication
