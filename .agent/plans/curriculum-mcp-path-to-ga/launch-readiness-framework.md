...
- **The target product** is a fresh React MCP App (clean-break rebuild on the
  ...
  **first-class, user-first graphical search-and-exploration experience**
  ...
  a teacher, delivered inside AI hosts (ChatGPT, Claude, Copilot, Gemini) and built on
...
- **K3 — Surface scope: the MCP app in ChatGPT, Claude, Copilot, and Gemini — which means the app's
  real dependency set must be GA-ready.** (Release surface owner-ratified 2026-06-17 as
  ChatGPT/Claude/Gemini, extended to include Copilot per owner direction 2026-06-26; the four
  match the canonical target platforms in the SSOT, `docs/strategy/stream-mcp-app.md`.) Declaring the app live asserts that
  ...
  ChatGPT/Claude/Copilot/Gemini **require vendor collaboration** — the vendors are aware and have **agreed**
