...
| P0 | [sentry-observability-maximisation.plan.md](./sentry-observability-maximisation.plan.md) | Strategic parent for closing every available Sentry product loop across MCP (server + widget) and Search CLI; executable lane in `active/` for the MCP branch |
