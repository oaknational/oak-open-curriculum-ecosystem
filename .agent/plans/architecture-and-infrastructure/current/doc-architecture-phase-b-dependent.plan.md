...
document (`.agent/research/notes/architecture/boundary-enforcement-with-eslint.md`, relocated 2026-04-22 per [PDR-032](../../../practice-core/decision-records/PDR-032-reference-tier-as-curated-library.md))
