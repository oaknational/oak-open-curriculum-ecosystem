...
- [Upstream API Wishlist](./external/ooc-api-wishlist/index.md)
- [Pattern-Aware Ingestion Plan](./semantic-search/active/pattern-aware-ingestion.md) — Implementation plan
