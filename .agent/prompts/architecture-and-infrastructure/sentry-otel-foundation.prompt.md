...
1. [sentry-otel-integration.execution.plan.md](../../plans-backlog-2026-07/architecture-and-infrastructure/active/sentry-otel-integration.execution.plan.md)
2. sentry-canonical-alignment.plan.md (`../../plans-old-archive/architecture-and-infrastructure/archive/completed/sentry-canonical-alignment.plan.md`)
   (archived 2026-04-17 — read for historical context on the child-plan scope)
3. [sentry-observability-maximisation-mcp.plan.md](../../plans-backlog-2026-07/observability/active/sentry-observability-maximisation-mcp.plan.md)
   (executable) and [future/sentry-observability-maximisation.plan.md](../../plans-backlog-2026-07/observability/future/sentry-observability-maximisation.plan.md)
