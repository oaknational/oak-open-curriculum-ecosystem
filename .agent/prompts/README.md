...
| [architecture-and-infrastructure/sentry-otel-foundation.prompt.md](architecture-and-infrastructure/sentry-otel-foundation.prompt.md) | handover | Session entry point for the active Sentry + OpenTelemetry foundation workstream across the HTTP MCP server and Search CLI; Phase 1 code is already on disk, so restart with the recorded blocker-remediation bundle and consult the paired review checkpoint before trusting compressed context | [sentry-otel-integration.execution.plan.md](../plans/architecture-and-infrastructure/active/sentry-otel-integration.execution.plan.md), [sentry-otel-foundation.review-checkpoint-2026-03-27.md](../plans/architecture-and-infrastructure/active/sentry-otel-foundation.review-checkpoint-2026-03-27.md) |
