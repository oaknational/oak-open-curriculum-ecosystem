...
| [strategy-and-plan-estate/define-strategy-content.prompt.md](strategy-and-plan-estate/define-strategy-content.prompt.md) | handover | **Strategy-content authoring session** (scope-locked to Body 2 — the `docs/strategy/` corpus): ground sources, the decided structure (choices+measures, portfolio+per-stream, enumerable strategic-choice IDs), settled owner inputs + release/compliance named hand-offs, the open diagnosis/granularity decisions, and the product-vs-engineering decision-locus discipline | [vision-strategy-and-plan-estate.plan.md §Body 2](../plans/vision-strategy-and-plan-estate.plan.md) |
