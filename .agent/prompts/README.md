...
| [semantic-search/semantic-search.prompt.md](semantic-search/semantic-search.prompt.md) | handover | Primary semantic-search session entry point with active authority, branch state, current lane order, and next-session actions | [semantic-search/current/README.md](../plans/semantic-search/current/README.md), [f2-closure-and-p0-ingestion.execution.plan.md](../plans/semantic-search/active/f2-closure-and-p0-ingestion.execution.plan.md), [bulk-canonical-merge-api-parity-and-validation.execution.plan.md](../plans/semantic-search/active/bulk-canonical-merge-api-parity-and-validation.execution.plan.md), [search-ingestion-sdk-extraction.execution.plan.md](../plans/semantic-search/active/search-ingestion-sdk-extraction.execution.plan.md) |
