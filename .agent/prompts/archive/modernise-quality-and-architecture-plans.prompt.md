# Modernise quality-and-maintainability/ and architecture-and-infrastructure/ Plan Directories

**Status**: COMPLETE (2026-02-23)

Merged both directories into a single `architecture-and-infrastructure/` directory. Archived 5
...
### `.agent/plans/architecture-and-infrastructure/` (5 files)
