...
import { scrubSensitiveData } from '../../../../chora/aither/immunity/scrubbing.js';

/**
 * Handles the special discovery resource
 */
export async function handleDiscoveryResource(deps: CoreDependencies): Promise<ReadResourceResult> {
...
function filterFullResponses(
  searchResponse: Awaited<ReturnType<CoreDependencies['notionClient']['search']>>,
