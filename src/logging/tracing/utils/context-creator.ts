/**
 * @fileoverview Trace context creation utilities
 * @module @oak-mcp-core/logging/tracing/utils
 */

import type { TraceContext } from '../types.js';
import { generateRequestId, generateSpanId } from './id-generator.js';
import { parseTraceparent } from './header-parser.js';
