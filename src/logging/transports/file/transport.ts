/**
 * @fileoverview File transport implementation
 * @module @oak-mcp-core/logging
 *
 * Core transport logic for file-based logging
 * Focused on buffering and lifecycle management
 */

import type { FileWriter, FileTransportOptions, FileLogTransport } from './types.js';
