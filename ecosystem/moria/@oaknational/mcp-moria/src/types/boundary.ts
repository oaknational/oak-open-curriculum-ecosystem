 ...
 */
export type PureTransform<TInput, TOutput> = (
  input: Pure<TInput>
) => Pure<TOutput>;
 ...
 */
export type EffectfulOperation<TInput, TOutput> = (
  input: TInput
) => Effect<TOutput>;
 ...
 */
export const isPure = <T>(
  computation: Computation<T>
): computation is Pure<T> => {
 ...
 */
export const sequenceEffects = async <T>(
