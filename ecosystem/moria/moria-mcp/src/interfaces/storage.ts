 ...
 * storage mechanism.
 *
 * All storage operations are async to support both file systems and network-based
 * storage systems uniformly.
 */
...
// For backward compatibility, export as AsyncStorageProvider too
